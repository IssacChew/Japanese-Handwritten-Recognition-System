package com.example.japaneserecognitionsystem.paint;
...
public class PaintView extends View {
    ...
    //Create the transform matrix for scaling up and centering the bitmap that will represent our character image inside the view.
    //The inverse matrix is also created for mapping touch coordinates to coordinates within the bitmap.
    ...
    //Gets the coordinates in the bitmap based on the the coordinates of where the user touched.
    ...
    //encapsulate the path and paint information related to drawing on the bitmap/canvas.
